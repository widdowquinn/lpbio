...
def test_create_job():
    ...
    job = pysge.Job(name="test_job", command="echo {}".format(time.asctime()))


def test_create_job_dependencies():
    """Create Job with dependencies for SGE-like scheduler"""
    job = pysge.Job(name="test_job_dependencies", command="echo {}".format(time.asctime()))
    job.dependencies = [
        pysge.Job(
...
def test_create_jobgroup():
    ...
    args = {"arg1": ["a", "b", "c"]}
    jobgroup = pysge.JobGroup(name="test_jobgroup", command="echo", arguments=args)


def test_create_jobgroup_dependencies():
    """Create parameter-sweep JobGroup with dependencies for SGE-like scheduler"""
    args = {"arg1": ["a", "b", "c"]}
    jobgroup = pysge.JobGroup(name="test_jobgroup_dependencies", command="echo", arguments=args)
...
def test_create_run_jobgroup():
    ...
    args = {"arg1": ["a", "b", "c"]}
    jobgroup = pysge.JobGroup(name="test_run_jobgroup", command="echo", arguments=args)
...
def test_create_run_job_dependencies():
    ...
    job = pysge.Job(name="test_run_job_dependencies", command="echo {}".format(time.asctime()))
    job.dependencies = [
        pysge.Job(
            name="dependency {}".format(i), command="echo {}".format(time.asctime())
        )
...
def test_create_run_jobgroup_dependencies():
    """Create parameter-sweep JobGroup with dependencies for SGE-like scheduler"""
    args = {"arg1": ["a", "b", "c"]}
    jobgroup = pysge.JobGroup(name="test_run_jobgroup_dependencies", command="echo", arguments=args)
    jobgroup.dependencies = [
        pysge.Job(
            name="dependency {}".format(i), command="echo {}".format(time.asctime())
        )
